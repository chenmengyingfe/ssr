/*! eruda-geolocation v1.1.0 https://github.com/liriliri/eruda-geolocation#readme */
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["erudaGeolocation"] = factory();
	else
		root["erudaGeolocation"] = factory();
...
module.exports = function (eruda) {
  ...
  var Geolocation = function (_eruda$Tool) {
    (0, _inherits3.default)(Geolocation, _eruda$Tool);
    ...
    function Geolocation() {
      ...
      _this.name = 'geolocation';
      _this._style = evalCss(__webpack_require__(94));
      return _this;
    }
    ...
    (0, _createClass3.default)(Geolocation, [{
      ...
      value: function init($el, container) {
        (0, _get3.default)(Geolocation.prototype.__proto__ || (0, _getPrototypeOf2.default)(Geolocation.prototype), 'init', this).call(this, $el, container);
        $el.html(__webpack_require__(96)());
      ...
      key: 'show',
      value: function show() {
        (0, _get3.default)(Geolocation.prototype.__proto__ || (0, _getPrototypeOf2.default)(Geolocation.prototype), 'show', this).call(this);
      ...
      value: function resetView() {
        ...
        navigator.geolocation.getCurrentPosition(function (position) {
          ...
          _this2.setView(latitude, longitude);
        }, function (e) {
          _this2.setInfo(e.message);
        });
      }
    }, {
      key: 'setView',
      value: function setView(latitude, longitude) {
        if (!this._map) return;
      ...
      key: 'setInfo',
      value: function setInfo(text) {
        this._$info.text(text);
      }
    }, {
      key: 'hide',
      value: function hide() {
        (0, _get3.default)(Geolocation.prototype.__proto__ || (0, _getPrototypeOf2.default)(Geolocation.prototype), 'hide', this).call(this);
      }
    }, {
      key: 'destroy',
      value: function destroy() {
        (0, _get3.default)(Geolocation.prototype.__proto__ || (0, _getPrototypeOf2.default)(Geolocation.prototype), 'destroy', this).call(this);
      ...
      value: function _initMap() {
        ...
        (0, _util.loadCss)('https://unpkg.com/leaflet@1.3.1/dist/leaflet.css', this._$el.get(0));
        (0, _util.loadJs)('https://unpkg.com/leaflet@1.3.1/dist/leaflet.js', function (isLoaded) {
          if (!isLoaded) return _this3.setInfo('Failed to init map');

          _this3.setInfo('Map successfully initialized');

          _this3._map = L.map(_this3._$el.find('#eruda-map').get(0)).setView([39.9, 116.39], 12);
...
var _handlebarsBase = __webpack_require__(45);
